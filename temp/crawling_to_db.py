...
keyword = "신지예 OR 녹색당  -filter:retweets"                           # OR 로 검색어 묶어줌, 검색어 5개(반드시 OR 대문자로)
...
try:
  # api 생성
  cursor = tweepy.Cursor(api.search, q=keyword, since='2015-01-01', geocode=location, result_type="recent", include_entities=True, wait_on_rate_limit=True)
